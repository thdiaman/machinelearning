...
\lstinputlisting{../DecisionTrees/decision_tree.py}

\newpage
\section{Example 2 - Numerical Data}
\lstinputlisting{../DecisionTrees/decision_tree_full.py}


\chapter{Classification with Naive Bayes}

\section{Example 1 - Categorical Data}
\lstinputlisting{../NaiveBayes/naive_bayes.py}

\section{Example 2 - Numerical Data}
\lstinputlisting{../NaiveBayes/naive_bayes_full.py}


\chapter{Classification with SVM}

\section{Example}
\lstinputlisting{../SVM/svm.py}


\chapter{Regression with KNN}

\section{Example 1 - Classification using KNN}
\lstinputlisting{../KNN/knn.py}

\newpage
\section{Example 2 - Regression using KNN}
\lstinputlisting{../KNN/knn_reg.py}


\chapter{Linear Regression}

\section{Example}
\lstinputlisting{../LinearRegression/linear_regression.py}


\chapter{Polynomial Regression}

\section{Example}
\lstinputlisting{../PolynomialRegression/polynomial_regression.py}


\chapter{Feature Selection}

\section{Example 1 - Feature Selection using Correlation}
\lstinputlisting{../FeatureSelection/feature_selection.py}

\newpage
\section{Example 2 - Feature Selection using Mutual Information}
\lstinputlisting{../FeatureSelection/feature_selection_mi.py}


\chapter{Feature Extraction}

\section{Example 1 - Feature Extraction}
\lstinputlisting{../FeatureExtraction/pca.py}

\newpage
\section{Example 2 - Classification using Feature Extraction}
\lstinputlisting{../FeatureExtraction/pca_full.py}


\chapter{Clustering with K-Means}

\section{Example}
\lstinputlisting{../KMeans/kmeans.py}


\chapter{Hierarchical Clustering}

\section{Example 1 - Single and Complete}
\lstinputlisting{../HierarchicalClustering/hier.py}

\newpage
\section{Example 2 - Scaling}
\lstinputlisting{../HierarchicalClustering/hier_c.py}
